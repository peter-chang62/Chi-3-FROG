...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gv_frog_2 = GraphicsLayoutWidget(self.groupbox)
        self.gv_frog_2.setObjectName("gv_frog_2")
        self.horizontalLayout_2.addWidget(self.gv_frog_2)
        self.gv_frog_3 = GraphicsLayoutWidget(self.groupbox)
        ...
        self.gv_frog_autocorr_2 = PlotWidget(self.splitter)
        self.gv_frog_autocorr_2.setMaximumSize(QtCore.QSize(16777215, 200))
        self.gv_frog_autocorr_2.setObjectName("gv_frog_autocorr_2")
        self.gv_frog_autocorr_3 = PlotWidget(self.splitter)
        self.gv_frog_autocorr_3.setMaximumSize(QtCore.QSize(16777215, 200))
        self.gv_frog_autocorr_3.setObjectName("gv_frog_autocorr_3")
        self.verticalLayout_7.addWidget(self.splitter)
        self.gridLayout_7.addLayout(self.verticalLayout_7, 0, 1, 2, 1)
        spacerItem17 = QtWidgets.QSpacerItem(88, 713, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Load FROG"))
        self.pushButton_3.setText(_translate("MainWindow", "Save Retrieval"))
        self.pushButton_2.setText(_translate("MainWindow", "Start Retrieval"))
        self.pushButton_4.setText(_translate("MainWindow", "Stop Retrieval"))
