...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1428, 1068)
        MainWindow.setMinimumSize(QtCore.QSize(1038, 783))
        ...
        self.label_2.setMinimumSize(QtCore.QSize(204, 84))
        ...
        spacerItem = QtWidgets.QSpacerItem(1189, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.groupBox6 = QtWidgets.QGroupBox(self.tab_settings)
        self.groupBox6.setMinimumSize(QtCore.QSize(344, 257))
        self.groupBox6.setMaximumSize(QtCore.QSize(344, 257))
        self.groupBox6.setObjectName("groupBox6")
        self.gridLayout_11 = QtWidgets.QGridLayout(self.groupBox6)
        self.gridLayout_11.setObjectName("gridLayout_11")
        self.formLayout = QtWidgets.QFormLayout()
        self.formLayout.setObjectName("formLayout")
        self.le_integration_time = QtWidgets.QLineEdit(self.groupBox6)
        ...
        self.tb_settings_error = QtWidgets.QTextBrowser(self.groupBox6)
        ...
        self.gridLayout_12.addWidget(self.groupBox6, 0, 0, 1, 1)
        ...
        self.verticalLayout_9 = QtWidgets.QVBoxLayout(self.groupBox7)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.groupBox8 = QtWidgets.QGroupBox(self.groupBox7)
        self.groupBox8.setMinimumSize(QtCore.QSize(671, 321))
        self.groupBox8.setObjectName("groupBox8")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.groupBox8)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.gv_ret_exp = GraphicsLayoutWidget(self.groupBox8)
        self.gv_ret_exp.setObjectName("gv_ret_exp")
        self.horizontalLayout_2.addWidget(self.gv_ret_exp)
        self.gv_ret_recon = GraphicsLayoutWidget(self.groupBox8)
        ...
        self.groupBox9 = QtWidgets.QGroupBox(self.groupBox7)
        self.groupBox9.setMaximumSize(QtCore.QSize(16777215, 291))
        self.groupBox9.setObjectName("groupBox9")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.groupBox9)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.gv_ret_marginal_t = PlotWidget(self.groupBox9)
        self.gv_ret_marginal_t.setObjectName("gv_ret_marginal_t")
        self.horizontalLayout_3.addWidget(self.gv_ret_marginal_t)
        self.gv_ret_marginal_v = PlotWidget(self.groupBox9)
        self.gv_ret_marginal_v.setObjectName("gv_ret_marginal_v")
        self.horizontalLayout_3.addWidget(self.gv_ret_marginal_v)
        self.verticalLayout_9.addWidget(self.groupBox9)
        self.gridLayout_7.addWidget(self.groupBox7, 0, 1, 4, 1)
        ...
        self.groupBox10.setMaximumSize(QtCore.QSize(264, 141))
        self.groupBox10.setObjectName("groupBox10")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.groupBox10)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.horizontalLayout_12 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_12.setObjectName("horizontalLayout_12")
        self.label = QtWidgets.QLabel(self.groupBox10)
        self.label.setObjectName("label")
        self.horizontalLayout_12.addWidget(self.label)
        self.le_niter = QtWidgets.QLineEdit(self.groupBox10)
        ...
        self.tb_ret_error = QtWidgets.QTextBrowser(self.groupBox10)
        self.tb_ret_error.setObjectName("tb_ret_error")
        self.verticalLayout_8.addWidget(self.tb_ret_error)
        self.gridLayout_7.addWidget(self.groupBox10, 1, 0, 1, 1)
        self.groupBox11 = QtWidgets.QGroupBox(self.tab)
        self.groupBox11.setObjectName("groupBox11")
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(self.groupBox11)
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.rb_marginals = QtWidgets.QRadioButton(self.groupBox11)
        ...
        self.rb_retrieval = QtWidgets.QRadioButton(self.groupBox11)
        self.rb_retrieval.setObjectName("rb_retrieval")
        self.verticalLayout_10.addWidget(self.rb_retrieval)
        self.gridLayout_7.addWidget(self.groupBox11, 2, 0, 1, 1)
        self.groupBox12 = QtWidgets.QGroupBox(self.tab)
        self.groupBox12.setMaximumSize(QtCore.QSize(278, 196))
        self.groupBox12.setObjectName("groupBox12")
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(self.groupBox12)
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout()
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.gridLayout_5 = QtWidgets.QGridLayout()
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.pb_load_frog = QtWidgets.QPushButton(self.groupBox12)
        self.pb_load_frog.setObjectName("pb_load_frog")
        self.gridLayout_5.addWidget(self.pb_load_frog, 0, 0, 1, 1)
        self.pb_save_ret = QtWidgets.QPushButton(self.groupBox12)
        self.pb_save_ret.setObjectName("pb_save_ret")
        self.gridLayout_5.addWidget(self.pb_save_ret, 0, 1, 1, 1)
        self.pb_start_ret = QtWidgets.QPushButton(self.groupBox12)
        self.pb_start_ret.setObjectName("pb_start_ret")
        self.gridLayout_5.addWidget(self.pb_start_ret, 1, 0, 1, 1)
        self.pb_stop_ret = QtWidgets.QPushButton(self.groupBox12)
        ...
        self.pb_crop_frog = QtWidgets.QPushButton(self.groupBox12)
        ...
        self.progbar_iter = QtWidgets.QProgressBar(self.groupBox12)
        ...
        self.progbar_windows = QtWidgets.QProgressBar(self.groupBox12)
        ...
        self.gridLayout_7.addWidget(self.groupBox12, 0, 0, 1, 1)
        self.tabWidget.addTab(self.tab, "")
        self.gridLayout_13.addWidget(self.tabWidget, 1, 0, 1, 2)
